...
function setAuthMode(mode) {
    ...
    authSubtitle.textContent = 'Sign in to save scores to the leaderboard. WINNERS GET PRIZES!';
...
async function handleLogin() {
    ...
    const password = btoa(username + ':' + email).slice(0, 24);
    ...
    if (!email) {
        setAuthStatus('Enter your username and email.', true);
        return;
    }
